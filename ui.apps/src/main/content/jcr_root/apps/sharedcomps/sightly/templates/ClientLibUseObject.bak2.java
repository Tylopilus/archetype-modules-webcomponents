// package apps.sharedcomps.sightly.templates;
...
// *
// * This class is mostly code from
// * /libs/granite/sightly/templates/ClientLibUseObjec.java, found in your local
// * AEM instance. The differences are that this class gets the 'loading' and
// * 'onload' attributes, gets the categories retrieved from
// * {@link com.day.cq.widget.HtmlLibraryManager#getLibraries(String[],
// LibraryType, boolean, boolean)}
// * and writes it's own HTML script elements rather than have the HtmlLibrary
// * manger do it for us using
// * {@link
// com.day.cq.widget.HtmlLibraryManager#writeIncludes(SlingHttpServletRequest,
// Writer, String...)}.
// *
...
// * 'defer' and 'async'. Valid values are listed in {@link
// #VALID_JS_ATTRIBUTES}.
// */
// private static final String BINDINGS_LOADING = "loading";

// /**
// * Sightly parameter that becomes the javascript function value in the script
// * element's 'onload' attribute.
// */
...
// * HTML 5.
// */
// private static final String TAG_JAVASCRIPT = "<script
// src=\"%s\"%s></script>";

// /**
// * HTML markup for stylesheets.
// */
// private static final String TAG_STYLESHEET = "<link rel=\"stylesheet\"
...
// */
// private static final List<String> VALID_JS_ATTRIBUTES = new
// ArrayList<String>() {
// {
// add("async");
// add("defer");
...
// * elements.
// */
// private static final List<String> VALID_CROSS_ORIGIN_VALUES = new
// ArrayList<String>() {
// {
// add("anonymous");
// add("use-credentials");
...
// private Boolean moduleAttribute;
...
// * and the two additional bindings for loading and onload.
// *
...
// moduleAttribute = (Boolean) bindings.getOrDefault("module", false);
// mode = (String) bindings.get(BINDINGS_MODE);

// // for (String cat : categories) {
// // log.error(cat);
// // }
// log.error(((Boolean) bindings.containsKey("mediaOnLoad")).toString());
...
// * HtmlLibraryManger's writeIncludes methods have been replaced with calls to
// * #includeLibraries.
// *
...
// if (categories == null || categories.length == 0) {
// log.error(
// "'categories' option might be missing from the invocation of the
// /apps/beagle/sightly/templates/clientlib.html"
// + "client libraries template library. Please provide a CSV list or an array
...
// Collection<ClientLibrary> libs = htmlLibraryManager.getLibraries(categories,
// libraryType, false, false);
...
// }
// // attribute = " ".concat(loadingAttribute.toString());
// if (moduleAttribute) {
// attribute = " ".concat("type=\"module\"");
// }
...
// attribute = attribute.concat(String.format(CROSS_ORIGIN_ATTRIBUTE,
// crossoriginAttribute.toLowerCase()));
// }

// for (ClientLibrary lib : libs) {
// String path = getIncludePath(request, lib, libraryType,
// htmlLibraryManager.isMinifyEnabled());

// if (path != null) {
// out.format(libraryType.equals(LibraryType.JS) ? TAG_JAVASCRIPT :
// TAG_STYLESHEET, path, attribute);
// }
// }
// }
// }
...
// /**
// * Returns the include path for the given library and type, respecting the
// proxy
// * settings.
// *
// * @param lib library
...
// *
// * @see
// com.adobe.granite.ui.clientlibs.impl.HtmlLibraryWriter#getIncludePath(SlingHttpServletRequest,
// * ClientLibrary, LibraryType, boolean)
// */
// private String getIncludePath(SlingHttpServletRequest request, ClientLibrary
// lib, LibraryType type, boolean minify) {
// String path = lib.getIncludePath(type, minify);
// if (lib.allowProxy() && (path.startsWith("/libs/") ||
