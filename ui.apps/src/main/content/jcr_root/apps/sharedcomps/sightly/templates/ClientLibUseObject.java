...
public class ClientLibUseObject implements Use {
  ...
  public static final String CLIENTLIB_BINDINGS_ONLOADMEDIA = "onLoadMedia";
  ...
  private static final String CLIENTLIB_PROPERTY_ESMODULE = "esModule";
  private static final String CLIENTLIB_PROPERTY_NOMODULE = "noModule";
  public static final String CLIENTLIB_PROPERTY_ONLOADMEDIA = "onLoadMedia";

  private static final String CLIENTLIB_TAG_JAVASCRIPT = "<script src=\"%s\"%s></script>";
  private static final String CLIENTLIB_TAG_STYLESHEET = "<link rel=\"stylesheet\" href=\"%s\"%s>";
  private static final String CLIENTLIB_TAG_ONLOADMEDIA = "media=\"none\" onload=\"media='all'\"";

  protected String[] categories;
  protected String mode;
  protected Boolean esModule;
  protected Boolean onLoadMedia;
   ...
   *
   * @param out         {@link PrintWriter} object responsible for writing the
   *                    HTML
  ...
  /**
   * Returns the include path for the given lib and libraryType, respecting the
   * proxy settings.
   *
   ...
   */
  protected final String getIncludePath(final SlingHttpServletRequest request, final ClientLibrary lib,
      final LibraryType libraryType, final boolean minify) {
  ...
  /**
   * Checks if the provided {@link ClientLibrary} should use the '/etc.clientlibs'
   * proxy path.
   *
   * @param lib  {@link ClientLibrary} instance
   ...
   *                    HTML
   */
  protected void generateOutputForClientLib(final ClientLibrary lib, final String path, final LibraryType libraryType,
  ...
  protected StringBuilder getLibraryTypeAttributes(final ClientLibrary lib, final LibraryType libraryType) {
    ...
    if (libraryType.equals(LibraryType.CSS)) {
      if (clientlibHasProperty(lib, CLIENTLIB_BINDINGS_ONLOADMEDIA)) {
        attributes.append(CLIENTLIB_TAG_ONLOADMEDIA);
      }
    }
